...
image_directory = 'Desktop/My_GitHub/Image_outlier/carpet/train/'
SIZE = 64
...
test1 = test.astype("float32") / 255.0

#Let us also load bad images to verify our trained model. 

image_directory = 'Desktop/My_GitHub/Image_outlier/carpet/test/'
